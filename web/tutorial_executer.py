...
steps = [
    {'page': 'tutorial-front-end.html', 'hand': ['copper', 'copper', 'copper', 'estate', 'estate'], 'message': 'Welcome to Dominion! We\'ll get you playing as soon as we can. We have no actions to play right now, so let\'s start by ending our action phase.', 'turn_info': {'Actions': 1, 'Money': 0, 'Buys': 1}, 'end_what': 'End Action', 'click': 'end'},
    ...
    {'page': 'tutorial-front-end.html', 'hand': ['copper', 'copper', 'copper', 'estate'], 'message': 'We\'re out off actions, but we got two money from playing militia. Let\'s go to our buy phase.', 'turn_info': {'Actions': 0, 'Money': 2, 'Buys': 1}, 'end_what': 'End Action', 'click': 'end'},
